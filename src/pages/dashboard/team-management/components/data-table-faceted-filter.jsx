...
export function DataTableFacetedFilter({ title, filterKey, options }) {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-[280px] p-0 bg-[#D19EDB] " align="start">
        <Command>
          ...
          <CommandList>
            ...
            <CommandGroup className="">
              {options.map((option) => {
                ...
                return (
                  <CommandItem
                    className="hover:bg-white dark:hover:bg-white dark:hover:text-black "
                    key={option.value}
                    onSelect={() => {
                      if (isSelected) {
                        updateFilters({
