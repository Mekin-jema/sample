  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-0 right-16 w-auto z-10 shadow-lg rounded-lg p-2"
      >
        <div className="flex overflow-x-auto space-x-2 p-2 scrollbar-hide rounded-xl bg-white shadow-lg">
          {variablelStyles.map((style) => (
            <div
              key={style.name}
              className="relative flex-shrink-0 rounded-xl bg-white transition-all duration-200 ease-in-out hover:shadow-lg"
            ...
            >
              <img
                ...
                className={`w-12 h-12 cursor-pointer rounded-md transition-all ${selectedStyle === style.name
