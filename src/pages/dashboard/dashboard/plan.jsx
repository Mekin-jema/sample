...
export default function PricingPlans() {
  ...
  return (
    <Dialog className="p-4 space-y-4 ">
      ...
      <DialogContent
       className="max-w-md backdrop-blur-sm !rounded-[25px] !border-none !p-6 shadow-lg"
        ...
        <Card className="border-none shadow-none">
          <CardContent className="space-y-4 px-0">
            ...
            <div className="space-y-4">
              ...
              <Select onValueChange={setSelectedBank} value={selectedBank} className="dark:bg-[#438179]">
                <SelectTrigger id="bank" className="w-full">
                  <SelectValue placeholder="Choose a bank" />
                </SelectTrigger>
                <SelectContent className="bg-[#E9EFEC]  hover:bg-[#438179d2] dark:bg-[#438179] border-none" >
                  {banks.map((bank) => (
                    <SelectItem key={bank.id} value={bank.id} className=" font-sora dark:bg-[#438179] dark:hover:bg-[#76c4b9d2] border-none">
                      {bank.name}
                    </SelectItem>
                  ))}
                </SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="pl-10 dark:bg-[#438179] text-white"
                    />
          ...
          <CardFooter className="px-0">
            <Button className="w-full bg-[#16423C] dark:bg-[#438179] text-white" disabled={!selectedBank || !cardNumber}>
              Finish
            </Button>
          </CardFooter>
        </Card>
